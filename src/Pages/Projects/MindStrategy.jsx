...
const MindStrategy = () => {
  const project = {
    ...
    fullDescription: "Mind Strategy is a comprehensive tour package website designed to provide users with an immersive experience in exploring travel destinations. Built with modern web technologies, it offers smooth animations, responsive design, and an intuitive user interface.",
    image: mind,
    tags: ["React", "TailwindCSS", "GSAP", "Responsive Design"],
    ...
    technologies: [
      { name: "React", description: "Frontend framework for building UI components" },
      { name: "TailwindCSS", description: "Utility-first CSS framework for styling" },
      { name: "GSAP", description: "Animation library for smooth transitions" },
      { name: "React Router", description: "Navigation and routing" }
    ],
    challenges: [
      {
        title: "Performance Optimization",
        description: "Ensuring smooth animations while maintaining fast load times"
      },
      {
        title: "Responsive Design",
        description: "Creating a seamless experience across all device sizes"
      }
    ],
    screenshots: [mind, mind, mind] // Add more screenshots
  };
          ...
          <div className="space-y-6">
            {project.challenges.map((challenge, index) => (
              <div key={index} className="bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-white/10">
                <h3 className="text-xl font-semibold text-purple-400 mb-3">{challenge.title}</h3>
